...
public class CsvWriter {
	...
	public CsvWriter(String fileName, char delimiter, Charset charset) throws IOException {
		if (fileName == null) {
	...
	/**
	 * Creates an object using a Writer to write data to.
	 * 
	 * @param outputStream
	...
	/**
	 * Creates an object using an OutputStream to write data to.
	 * 
	 * @param outputStream
	 *            The stream to write the column delimited data to.
	 * @param delimiter
